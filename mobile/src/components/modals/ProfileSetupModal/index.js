...
const ProfileSetupModal = ({ visible, onClose, onComplete, userProfile }) => {
  ...
  const renderStepContent = () => {
    ...
    switch (step.key) {
      ...
      case 'gender':
        return <GenderStep gender={setupData.gender} onGenderSelect={handleGenderSelect} />;

      case 'interestedIn':
        return (
          <InterestedInStep
            interestedIn={setupData.interestedIn}
            onInterestedInToggle={handleInterestedInToggle}
          />
        );
      ...
      case 'location':
        return <LocationStep location={setupData.location} />;
